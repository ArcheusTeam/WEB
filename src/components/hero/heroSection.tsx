...
const HeroSection: React.FC = () => {
  ...
  const toneColors: { [key: string]: string } = {
    ...
    'passif-agressif':
      'bg-gradient-to-br from-[#7F55B1] via-purple-700 to-gray-900',
  ...
  return (
    <section
      className={`relative min-h-screen ${toneColors[exitTones[textIndex]]} text-white flex flex-col justify-center items-center overflow-hidden transition-colors duration-500`}
    >
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <p className="text-xl md:text-2xl max-w-2xl mx-auto mb-8 animate-slide-up">
          Bienvenue sur{' '}
          <span className="text-[#7F55B1] font-bold">TheEnd.page</span> : la
          plateforme où chaque départ devient une légende. Créez votre page de
          sortie unique, choisissez votre ton —{' '}
          <span className="text-green-400 font-semibold transition-all duration-500 text-5xl">
            {exitTones[textIndex]}
          </span>{' '}
          — et faites de votre fin un moment inoubliable.
        </p>
        ...
        <div className="mt-8 animate-fade-in">
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-4">
            Les meilleures pages rejoignent le prestigieux{' '}
            <span className="text-green-400 font-bold">Hall of Fame</span>.
            Votez pour les départs les plus épiques et aidez-les à devenir
            immortels !
          </p>
          <div className="flex justify-center gap-3">
            <div className="w-12 h-12 bg-gray-700 rounded-full flex items-center justify-center animate-bounce">
              <svg
                className="w-6 h-6 text-[#7F55B1]"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
