...
const LoginCn = () => {
    ...
    const moods = [
        {
            ...
            citation: "« J’ai quitté avec le sourire et un GIF de licorne. Merci TheEnd.Page ! »",
            nom: "Camille R.",
            entreprise: "Ancienne cheffe de projet chez RainbowCorp"
        },
        {
            titre: "Ils ont quitté en mode cool 😎",
            citation: "« J’ai laissé un mix Spotify et une photo de moi en lunettes de soleil. »",
            nom: "Max B.",
    ...
    const emojis = ["🌈", "😎", "👻", "🐸"];
    const couleurs = ["bg-teal-500", "bg-blue-600", "bg-purple-600", "bg-green-600"];
        ...
        <div className="flex min-h-screen font-sans">
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <p className="mt-2 text-gray-300">
                            Créez votre page de départ inoubliable. Que ce soit un job, un projet ou une histoire d’amour, partagez votre dernier mot avec style.
                        </p>
                    </div>
                    ...
                    <AuthForm
                        fields={
                            estConnexion
                                ...
                                : [
                                    { name: "email", label: "Email", type: "email", placeholder: "jean@example.com" },
                                    { name: "username", label: "Nom d'utilisateur", type: "text", placeholder: "jean_dupont" },
                                    { name: "password", label: "Mot de passe", type: "password", placeholder: "••••••••" },
            ...
            <div
                ...
                <div className="transition-opacity duration-500 ease-in-out animate-fade-up-slow relative z-10">
                    <h2 className="text-4xl font-bold mb-4 max-w-2xl">{moods[indexCouleur].titre}</h2>
                    <p className="text-lg max-w-2xl mb-6 italic">{moods[indexCouleur].citation}</p>
                ...
                <div className="mt-8 p-6 bg-white text-black rounded-lg shadow max-w-2xl transition-all duration-300">
                    <h3 className="font-semibold mb-2">Votre dernière page, votre dernier mot</h3>
                    <p className="text-sm">
                        Personnalisez votre départ : choisissez un ton, ajoutez des GIFs, une musique, et partagez avec
                        vos proches.<br/>
                        Transformez une fin en souvenir inoubliable.
                    </p>
                    <a href="/end-pages" className="mt-4 inline-block font-bold underline">Découvrir les pages d'exemple →</a>
                </div>
            </div>
        </div>
    );
